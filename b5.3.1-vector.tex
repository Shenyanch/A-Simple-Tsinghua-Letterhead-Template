    ...
    \item[向量的夹角] 已知两个非零向量$\bm a$和$\bm b$，如图，做$\vv{OA}=\bm a$，$\vv{OB}=\bm b$，
      ...
      \begin{minipage}[b]{0.8\linewidth}
        \begin{itemize}
          ...
          \item 当$\theta=0\textdegree$时，向量$\bm a,\bm b$共线且同向；
          \item 当$\theta=90\textdegree$时，向量$\bm a,\bm b$相互垂直,记作$\bm a\perp \bm b$；
          \item 当$\theta=180\textdegree$时，向量$\bm a,\bm b$共线且反向.
        \end{itemize}
      \end{minipage}\hfill
