...
\section{向量的基本相关概念}
  ...
  \begin{exercise}{\textbf{基础测试}}
    ...
    \item
      ...
      \circled{5}若$\bm{a}\varparallel\bm{b}$，$\bm{c}\varparallel\bm{b}$，则$\bm{a}\varparallel\bm{c}$；
      \circled{6}有向线段就是向量，向量就是有向线段．其中，错误的个数是\xz
      \xx{2}{3}{4}{5}
  \end{exercise}
\section{向量的线性运算}
  ...
  \subsection{加法}
    \begin{description}
      ...
      \item[法则] 平行四边形法则或三角形法则
        ...
        由三角形法则，可得向量不等式：$$\abs{\bm{a}}+\abs{\bm{b}}\leqslant \abs{\bm{a}+\bm{b}}\leqslant \abs{\bm{a}}+\abs{\bm{b}}$$
      \item[运算律]
        \begin{itemize}%[leftmargin=*]
